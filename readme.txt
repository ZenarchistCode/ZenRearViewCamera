...
This mod adds a rear-view reverse mode camera to vehicles specified in the config file.
...
It also requires my ZenModCore mod to function.

When you run this mod for the first time it will create a config file in profiles/Zenarchist/ZenRearViewCameraConfig.json

This file contains the list of vehicle types to enable the rear view camera on.
